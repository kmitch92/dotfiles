...
if ! command -v rg >/dev/null 2>&1; then
  alias rg='/Users/kiel.mitchell/.vscode/extensions/anthropic.claude-code-2.0.0/resources/claude-code/vendor/ripgrep/arm64-darwin/rg'
fi
export PATH=/opt/homebrew/bin\:/Users/kiel.mitchell/bin\:/Users/kiel.mitchell/.local/bin\:/usr/local/bin\:/usr/local/bin\:/System/Cryptexes/App/usr/bin\:/usr/bin\:/bin\:/usr/sbin\:/sbin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/local/bin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/bin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/appleinternal/bin\:/Users/kiel.mitchell/.volta/bin\:/Users/kiel.mitchell/.local/bin
